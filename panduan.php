          ...
          if(isset($_GET['s'])){
            ?>
              <div class="header-content d-flex align-items-center mt-5 px-2 py-3">
                <h3 class="fw-bold mx-3 my-1">Buku Panduan</h3>
                <div class="act-buku">
            ...
            ?>
                <h3 class="header-content fw-bold mt-5 px-2 py-3">Buku Panduan</h3>
            <?php
          }
        ?>
        ...
        <?php
          ...
          while($result = mysqli_fetch_array($querypanduan)){
            ...
            <div class="p-3 book-text
             ...
             px-5">
              <a href="detail.php?nov=<?= $result['id_panduan']?>&dadm" class="book-title">
